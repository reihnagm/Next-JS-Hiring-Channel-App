...
export default function engineer(state = initialState, action) {
  ...
  switch (type) {
    ...
    case ADD_ENGINEERS_PORTFOLIO: 
      return {
        ...state, 
      }
    case ADD_ENGINEERS_PORTFOLIO_ERROR: 
      return {
        ...state, 
        error: payload
      }
